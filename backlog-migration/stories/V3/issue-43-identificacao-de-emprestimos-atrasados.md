<!-- libstock-eap-task: EAP-1.8.1 -->

## História de usuário

Como **atendente**,
quero **identificação de empréstimos atrasados**,
para **executar essa funcionalidade de acordo com as regras de negócio do LibStock**.

## Contexto

Esta história deriva da issue #43 e do planejamento original do projeto LibStock.
