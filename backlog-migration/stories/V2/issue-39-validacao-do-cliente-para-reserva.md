<!-- libstock-eap-task: EAP-1.7.2 -->

## História de usuário

Como **usuário do sistema**,
quero **validação do cliente para reserva**,
para **executar essa funcionalidade de acordo com as regras de negócio do LibStock**.

## Contexto

Esta história deriva da issue #39 e do planejamento original do projeto LibStock.
