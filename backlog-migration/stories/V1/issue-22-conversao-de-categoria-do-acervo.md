<!-- libstock-eap-task: EAP-1.3.7 -->

## História de usuário

Como **funcionário responsável pelo acervo**,
quero **conversão de categoria do acervo**,
para **executar essa funcionalidade de acordo com as regras de negócio do LibStock**.

## Contexto

Esta história deriva da issue #22 e do planejamento original do projeto LibStock.
...
- Dependências EAP: `1.3.5, 1.3.6, 1.2.6`
...
| --- | --- |
| ID EAP | 1.3.7 |
| Pacote principal | Gestão do Acervo |
| SP final | 8 |
| Dependencias | 1.3.5, 1.3.6, 1.2.6 |
| Responsavel | Danilo |
| Apoio | Sandy + Weslley |
| Horas previstas | 12h |
| Duracao em dias uteis | 3 |
| Valor/hora | R$ 30,00 |
| Custo previsto | R$ 360,00 |
