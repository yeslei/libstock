<!-- libstock-eap-task: EAP-1.5.3 -->

## História de usuário

Como **atendente**,
quero **calcular a data prevista de devolução**,
para **executar essa funcionalidade de acordo com as regras de negócio do LibStock**.

## Contexto

Esta história deriva da issue #30 e do planejamento original do projeto LibStock.
