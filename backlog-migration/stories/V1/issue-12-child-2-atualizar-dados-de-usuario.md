<!-- libstock-eap-task: EAP-1.2.4 -->

## História de usuário

Como **usuário do sistema**,
quero **atualizar dados de usuário**,
para **executar essa funcionalidade de acordo com as regras de negócio do LibStock**.

## Contexto

Esta história deriva da issue #12 e do planejamento original do projeto LibStock.
