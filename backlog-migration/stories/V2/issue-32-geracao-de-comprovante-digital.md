<!-- libstock-eap-task: EAP-1.5.5 -->

## História de usuário

Como **usuário do sistema**,
quero **gerar um comprovante digital**,
para **executar essa funcionalidade de acordo com as regras de negócio do LibStock**.

## Contexto

Esta história deriva da issue #32 e do planejamento original do projeto LibStock.
