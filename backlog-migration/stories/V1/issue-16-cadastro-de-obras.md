<!-- libstock-eap-task: EAP-1.3.1 -->

## História de usuário

Como **funcionário responsável pelo acervo**,
quero **cadastrar uma obra**,
para **manter o catálogo do acervo atualizado e permitir sua posterior consulta**.

## Contexto

Esta história deriva da issue #16 e do planejamento original do projeto LibStock.
