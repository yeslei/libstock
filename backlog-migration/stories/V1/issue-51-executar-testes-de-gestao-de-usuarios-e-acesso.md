...
Executar o trabalho definido em **[QA] Executar testes de gestão de usuários e acesso**, preservando o contexto e as dependências do planejamento original.
...
| --- | --- |
| ID EAP | 1.10.1 |
| Pacote principal | Testes e Validação |
| SP final | 5 |
| Dependencias | 1.2.5, 1.2.6, 1.2.7 |
| Responsavel | Sandy |
| Apoio | Danilo |
