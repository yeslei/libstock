<!-- libstock-eap-task: EAP-1.9.1 -->

## História de usuário

Como **administrador**,
quero **restrições de operações por nível de acesso**,
para **executar essa funcionalidade de acordo com as regras de negócio do LibStock**.

## Contexto

Esta história deriva da issue #47 e do planejamento original do projeto LibStock.
