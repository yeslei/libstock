<!-- libstock-eap-task: EAP-1.8.2 -->

## História de usuário

Como **usuário do sistema**,
quero **alerta visual de atraso**,
para **executar essa funcionalidade de acordo com as regras de negócio do LibStock**.

## Contexto

Esta história deriva da issue #44 e do planejamento original do projeto LibStock.
