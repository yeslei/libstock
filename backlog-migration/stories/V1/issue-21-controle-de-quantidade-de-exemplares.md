<!-- libstock-eap-task: EAP-1.3.6 -->

## História de usuário

Como **funcionário responsável pelo acervo**,
quero **controle de quantidade de exemplares**,
para **executar essa funcionalidade de acordo com as regras de negócio do LibStock**.

## Contexto

Esta história deriva da issue #21 e do planejamento original do projeto LibStock.
