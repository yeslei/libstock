<!-- libstock-eap-task: EAP-1.6.3 -->

## História de usuário

Como **funcionário responsável pelo acervo**,
quero **bloqueio de venda de exemplares didáticos**,
para **executar essa funcionalidade de acordo com as regras de negócio do LibStock**.

## Contexto

Esta história deriva da issue #36 e do planejamento original do projeto LibStock.
