<!-- libstock-eap-task: EAP-1.8.3 -->

## História de usuário

Como **atendente**,
quero **envio de lembrete de devolução**,
para **executar essa funcionalidade de acordo com as regras de negócio do LibStock**.

## Contexto

Esta história deriva da issue #45 e do planejamento original do projeto LibStock.
