<!-- libstock-eap-task: EAP-1.7.3 -->

## História de usuário

Como **atendente**,
quero **registro da reserva**,
para **executar essa funcionalidade de acordo com as regras de negócio do LibStock**.

## Contexto

Esta história deriva da issue #40 e do planejamento original do projeto LibStock.
