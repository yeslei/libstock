<!-- libstock-eap-task: EAP-1.5.4 -->

## História de usuário

Como **funcionário responsável pelo acervo**,
quero **atualizar o status de um exemplar**,
para **executar essa funcionalidade de acordo com as regras de negócio do LibStock**.

## Contexto

Esta história deriva da issue #31 e do planejamento original do projeto LibStock.
