<!-- libstock-eap-task: EAP-1.4.5 -->

## História de usuário

Como **atendente**,
quero **sinalização Venda/Empréstimo/Esgotado**,
para **executar essa funcionalidade de acordo com as regras de negócio do LibStock**.

## Contexto

Esta história deriva da issue #27 e do planejamento original do projeto LibStock.
