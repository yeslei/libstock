<!-- libstock-eap-task: EAP-1.4.4 -->

## História de usuário

Como **usuário do sistema**,
quero **consultar a disponibilidade de uma obra ou exemplar**,
para **saber se existem exemplares disponíveis para a operação desejada**.

## Contexto

Esta história deriva da issue #26 e do planejamento original do projeto LibStock.
...
| --- | --- |
| ID EAP | 1.4.4 |
| Pacote principal | Consulta do Acervo |
| SP final | 5 |
| Dependencias | 1.3.2, 1.3.6 |
| Responsavel | Danilo |
| Apoio | Weslley |
