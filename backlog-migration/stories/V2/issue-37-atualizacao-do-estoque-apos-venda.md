<!-- libstock-eap-task: EAP-1.6.4 -->

## História de usuário

Como **atendente**,
quero **atualização do estoque após venda**,
para **executar essa funcionalidade de acordo com as regras de negócio do LibStock**.

## Contexto

Esta história deriva da issue #37 e do planejamento original do projeto LibStock.
