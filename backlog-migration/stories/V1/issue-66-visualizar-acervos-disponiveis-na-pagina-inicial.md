...
quero **visualizar os acervos disponíveis na página inicial**,
para **acessar rapidamente os acervos disponíveis no sistema**.

## Contexto

Esta história deriva da issue #66 e do planejamento original do projeto LibStock.
