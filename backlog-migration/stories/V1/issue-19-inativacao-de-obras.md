<!-- libstock-eap-task: EAP-1.3.4 -->

## História de usuário

Como **funcionário responsável pelo acervo**,
quero **inativar uma obra**,
para **retirá-la das operações ativas preservando seu histórico no sistema**.

## Contexto

Esta história deriva da issue #19 e do planejamento original do projeto LibStock.
