<!-- libstock-eap-task: EAP-1.7.4 -->

## História de usuário

Como **atendente**,
quero **controle da fila de reservas**,
para **executar essa funcionalidade de acordo com as regras de negócio do LibStock**.

## Contexto

Esta história deriva da issue #41 e do planejamento original do projeto LibStock.
...
| --- | --- |
| ID EAP | 1.7.4 |
| Pacote principal | Reserva de Compra |
| SP final | 8 |
| Dependencias | 1.7.3 |
| Responsavel | Danilo |
| Apoio | Weslley |
