<!-- libstock-eap-task: EAP-1.3.2 -->

## História de usuário

Como **funcionário responsável pelo acervo**,
quero **cadastrar um exemplar**,
para **registrar uma unidade física da obra e controlar sua disponibilidade**.

## Contexto

Esta história deriva da issue #17 e do planejamento original do projeto LibStock.
