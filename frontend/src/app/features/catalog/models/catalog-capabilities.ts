 ...
 *
 * Modelado como capacidade e não como papel porque o SRS trata alguns pares
 * como o mesmo ator — "Atendentes de Caixa | Vendedores" e "Gerente | Dono:
 * Administrador" aparecem como um stakeholder cada. Checar capacidade evita
 * espalhar essa equivalência por todo template.
 */
