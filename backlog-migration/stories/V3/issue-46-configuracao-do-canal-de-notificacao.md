<!-- libstock-eap-task: EAP-1.8.4 -->

## História de usuário

Como **cliente**,
quero **configuração do canal de notificação**,
para **executar essa funcionalidade de acordo com as regras de negócio do LibStock**.

## Contexto

Esta história deriva da issue #46 e do planejamento original do projeto LibStock.
...
| --- | --- |
| ID EAP | 1.8.4 |
| Pacote principal | Alertas e Notificações |
| SP final | 8 |
| Dependencias | 1.2.2 |
| Responsavel | Weslley |
| Apoio | Danilo |
