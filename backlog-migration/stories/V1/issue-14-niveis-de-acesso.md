<!-- libstock-eap-task: EAP-1.2.6 -->

## História de usuário

Como **usuário do sistema**,
quero **níveis de acesso**,
para **executar essa funcionalidade de acordo com as regras de negócio do LibStock**.

## Contexto

Esta história deriva da issue #14 e do planejamento original do projeto LibStock.
