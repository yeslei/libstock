<!-- libstock-eap-task: EAP-1.2.3 -->

## História de usuário

Como **administrador**,
quero **cadastrar um funcionário**,
para **permitir que o funcionário utilize o sistema conforme suas permissões**.

## Contexto

Esta história deriva da issue #11 e do planejamento original do projeto LibStock.
